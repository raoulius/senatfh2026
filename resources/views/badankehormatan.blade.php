...
@section("content")
  ...
  <section class="container">
    <div class="section-header6">
      <h2 class="modern-header">Tugas Pokok dan Wewenang BADAN KEHORMATAN</h2>
    </div>
  ...
  <section class="container-k">
    ...
    @foreach ($agendas["Badan Kehormatan"] as $agenda)
  ...
  <section class="container">
    <h2 class="header">Anggota Badan Kehormatan</h2>
    <div class="anggota-4">
      <div class="card-coba">
        <div class="imgbox">
