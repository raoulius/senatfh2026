...
@section("content")
  ...
  <section class="container" id = "makna-logo">
    ...
    <h2 class="header3">MAKNA LOGO</h2>
    <div class="makna-senat">
      <div class="features">
        <div class="card">
          ...
          <div class="content">
            <h4>Warna Biru</h4>
            <p>
              Melambangkan kebijaksanaan dan mengayomi dari Senat Mahasiswa Fakultas Hukum Universitas Diponegoro terhadap para konstituen melalui para
              fungsionarisnya.
            </p>
          </div>
        </div>
        ...
        <div class="card">
          <span><i class="ri-circle-line"></i></span>
          <div class="content">
        ...
        <div class="card">
          ...
          <div class="content">
            <h4>Bintang</h4>
            <p>Melambangkan kebermanfaatan yang wajib diberikan oleh Senat Mahasiswa Fakultas Hukum Universitas Diponegoro terhadap konstituennya.</p>
          </div>
        </div>
        <div class="card">
          <span><i class="ri-scales-3-line"></i></span>
          <div class="content">
            <h4>Timbangan</h4>
            <p>
              Melambangkan rasa keadilan yang harus dirasakan oleh konstituennya dari segala kebijakan atau pelaksanaan fungsi yang dimiliki oleh Senat
              Mahasiswa Fakultas Hukum Universitas Diponegoro.
            </p>
          </div>
        </div>
        <div class="card">
          <span><i class="ri-sword-line"></i></span>
          <div class="content">
            <h4>Pedang</h4>
            <p>
              Melambangkan rasa pelindung, pengayom, dan keberanian sebagai sifat yang wajib dimiliki oleh setiap fungsionaris Senat Mahasiswa Fakultas Hukum
      ...
      <div class="features1">
        <div class="card">
          <span><img class="star-img" src="img/BintangMelingkar.png" alt="" /></span>
          <div class="content">
            <h4>Bintang yang Melingkar</h4>
            <p>
              Melambangkan bahwa Senat Mahasiswa Fakultas Hukum Universitas Diponegoro terdiri atas fungsionaris yang berasal dari latar belakang dan
              kepentingan yang berbeda tetapi tetap berjalan padu mencapai tujuan.
            </p>
          </div>
        </div>
      </div>
